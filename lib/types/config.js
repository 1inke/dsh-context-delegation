...
export const DEFAULT_CONTEXT_DELEGATION_CONFIG = Object.freeze({
    contextMode: 'lexical',
...
export const Config = z.object({
    ...
    reviewProviderName: z.string().min(1).default(undefined),
...
export function resolveConfig(config = {}) {
    ...
    if (contextMode !== 'lexical' && contextMode !== 'legacy')
        throw configError('contextMode must be lexical or legacy.');
