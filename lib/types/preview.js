...
import { assertDelegationInput, CODEX_EXPERT_PARAMETERS } from "./tool.js";
...
export function apply(ctx) {
    ctx.tools.register(defineTool({
        ...
        async execute(args, exec) {
            ...
            if (!exec.agent)
                throw new ContextDelegationError('WORKSPACE_NOT_FOUND', 'context_preview requires an Agent-backed session.', {
