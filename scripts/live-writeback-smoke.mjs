// Opt-in real-runtime context write-back smoke (V0.6 evidence).
//
// The reviewed loop runs in contextWriteback 'apply' mode: the real executor
// child creates a file AND proposes a DECISIONS.md entry in its structured
// report; after the fresh reviewer passes, the plugin applies the proposal
// to the context file, verifies parseability and the fingerprint change.
//
