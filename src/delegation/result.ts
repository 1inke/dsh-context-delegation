...
function reviewStatusLine(value: DelegationResult): string {
  const review = value.review
  if (review === undefined) return `Status: success (provider: ${value.provider}, run: ${value.runId})`
...
export function renderCodexExpertResult(value: DelegationResult): string {
