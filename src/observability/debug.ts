...
import { recentDelegationTraces, TRACE_RETENTION } from './trace.ts'
 ...
 */
export function createDelegationDebugTool(ctx: Context): ToolDefinition {
  return defineTool({
    name: 'delegation_debug',
    description:
      'Inspect this plugin\'s recent delegation metadata: routed executors, context revisions, '
