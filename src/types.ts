...
export interface ResolvedExecutorRouting {
  readonly implementation: { readonly provider: string; readonly model?: string }
...
export interface ContextPreview {
  ...
  readonly totalChars: number
  readonly maxContextChars: number
  readonly mandatory: readonly { relativePath: string; chars: number; truncated: boolean }[]
  readonly retrieved: readonly (Omit<ScoredContextChunk, 'content'> & { readonly includedChars: number })[]
